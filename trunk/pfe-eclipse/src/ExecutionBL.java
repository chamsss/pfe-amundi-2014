...
//        }
      ...
      //Définie positive
//        System.out.println(" VCV déf positive : " + v1.defPositive());
...
//        }
		...
		//Traitement Excel GlobalAGG
//		String fileAdress = "C:/Users/Alexandra/Dropbox/Black Litterman/GlobalAGG";
//		
//		TraitementExcel te = new TraitementExcel(fileAdress);
//		Bond[] test = te.traitementCsv();
//
//		System.out.println(test[1].getAmount_outstanding());
...
//        BlackLitterman bimp = new BlackLitterman(tau, aversion, vcv, poids);
//        
//        Matrix pimp = bimp.rendementsImplicites();
//        
//        for (int i=0 ; i<pimp.getRowDimension() ; i++) {
//			System.out.println(pimp.get(i,0) + "\n");
//		}
